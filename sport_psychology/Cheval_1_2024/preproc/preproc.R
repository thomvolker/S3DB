...
library(ltm)
library(hrbrthemes)
dataset <- read_excel("sport_psychology/Cheval_1_2024/preproc/Physical Effort Scale Data Fall 2022.xlsx")
...
write_csv(pes_na, "sport_psychology/Cheval_1_2024/dataset.csv")
