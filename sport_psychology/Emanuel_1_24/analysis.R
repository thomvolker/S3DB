...
if (!interactive()) {
  ...
  INPUT_FILE  <- "sport_psychology/Emanuel_1_24/synthetic_data/synthpop_cart.csv"
  OUTPUT_FILE <- "sport_psychology/Emanuel_1_24/results/synthpop_cart.csv"
}
...
# Conditional R^2 values to check that results match the paper:
